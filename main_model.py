...
class SY1_EX600_MODEL(BaseModel):
    ...
    def run_all_postprocessing(self):
    ...
    # breaking down sup_exh_porting_dir_and_cover_assy from HTO to get two fields:
    # --- porting_type
    # --- pe_port_entry
...
try:
    ...
    # print(f'light surge voltage suppressor: {manifold.lt_surge_volt_sup}')
    # print(f'coil type: {manifold.coil_type}')
    # print(manifold)
